<template>
    <div class="ti-input" :class="[disabled ? 'is-disabled' : null]" :style="`width:${width}`">
        <div class="ti-input-box">
            ...
            />
            <span
                class="ti-input--icon ti-icon"
                v-if="clearable && modelValue && clearIsShow"
            >
...
const emit = defineEmits(["input", "change", "focus", "blur", "clear", 'update:modelValue'])
